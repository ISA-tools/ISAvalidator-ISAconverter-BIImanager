...
public class StudyOperationCommon extends ViewingPane {
    ...
    public StudyOperationCommon(AppContainer container) {
        super(container);
        setOpaque(false);
    }
    ...
    protected Collection<Study> loadStudiesFromDatabase() {
        ...
        unloaderUtil = new GUIISATABUnloader();
    ...
    protected JLabel createBackToMainMenuButton() {
