...
public class ValidatorTitlePanel extends TitlePanel {
    ...
    private Image title = new ImageIcon(getClass().getResource("/images/validator/validator-title-logo.png")).getImage();
