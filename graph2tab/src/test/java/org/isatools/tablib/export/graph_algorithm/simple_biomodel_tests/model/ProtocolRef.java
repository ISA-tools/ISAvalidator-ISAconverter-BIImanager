 ...
 * @author brandizi
 */
public class ProtocolRef extends ExperimentNode {
	public ProtocolRef(String name) {
		super(name);
	}

	/**
	 * Protocol parameters are rendered as {@link Annotation}.
	 */
	public void addParameter(String type, String value, String termAcc, String termSrc) {
		super.addAnnotation(type, value, termAcc, termSrc);
	}

	protected List<Annotation> getParameters() {
