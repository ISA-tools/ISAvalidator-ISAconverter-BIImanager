...
public class IconixMappingTest {
	/**
	...
	public void testLoadingAndMapping() throws Exception {
		out.println("\n\n__________ Iconix Case Mapping Test __________\n\n");
		...
		String dotFileName = baseDir + "/target/iconix.dot";
		dotter.createGraph(dotFileName);
		out.println("\n\nExperimental Graph written in " + dotFileName);

		out.println("\n\n__________ /end: Iconix Case Mapping Test __________\n\n\n\n");
	}
