...
public class IconixPersistenceTest extends TransactionalDBUnitEJB3DAOTest {

	public IconixPersistenceTest() throws Exception {
		super();
	}
	...
	public void testPersistence() throws Exception {
		...
		for (Study study : store.valuesOfType(Study.class)) {
			assertTrue("Oh no! Submission didn't go to the repository!",
					new File(repoPath + "/study_" + DataLocationManager.getObfuscatedStudyFileName(study)).exists()
			);
		}
