...
public class FooFormatTabMapper extends FormatTabMapper {

	public FooFormatTabMapper(BIIObjectStore store, FormatInstance formatInstance) {
		super(store, formatInstance);
		sectionMappersConfig.put("news", NewsTabMapper.class);
		sectionMappersConfig.put("pubs", PublicationTabMapper.class);
	}
