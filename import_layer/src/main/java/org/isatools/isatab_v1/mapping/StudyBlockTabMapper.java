...
public class StudyBlockTabMapper extends SectionBlockTabMapper {
    ...
    public StudyBlockTabMapper(BIIObjectStore store, SectionInstance firstSection) {
        ...
        sectionMappersConfig.put("studyDesigns", DesignTabMapper.class);
        ...
        sectionMappersConfig.put("contacts", StudyContactTabMapper.class);
        sectionMappersConfig.put("studyPubs", StudyPublicationTabMapper.class);
    }
    ...
    public BIIObjectStore map() {
        ...
        for (SectionTabMapper mapper : tabMappers) {
            ...
            if (mapper instanceof StudyTabMapper) {
                ...
                store.put(StudyWrapper.class, studyFileId, studyWrapper);
            }
