 ...
 * @author brandizi
 */
public class InvestigationContactRoleMappingHelper extends MultiValueOEMappingHelper<Contact, ContactRole> {

    /**
     * It is defined to be used with MappingHelperConfig, values in options are ignored, since they are constant in this
     * mapper.
     */
    public InvestigationContactRoleMappingHelper(BIIObjectStore store, SectionInstance sectionInstance,
                                                 Map<String, String> options, int fieldIndex) {
        this(store, sectionInstance, fieldIndex);
    }

    public InvestigationContactRoleMappingHelper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex) {
        super(store, sectionInstance,
                "Investigation Person Roles", "Investigation Person Roles Term Accession Number",
                "Investigation Person Roles Term Source REF", "roles",
                fieldIndex
        );
    }
