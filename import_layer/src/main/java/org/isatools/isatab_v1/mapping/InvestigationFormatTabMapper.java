...
import org.isatools.isatab.mapping.InvestigationTabMapper;
import org.isatools.isatab.mapping.OntologySourceTabMapper;
import org.isatools.tablib.mapping.FormatTabMapper;
import org.isatools.tablib.schema.FormatInstance;
import org.isatools.tablib.utils.BIIObjectStore;

public class InvestigationFormatTabMapper extends FormatTabMapper {
    public InvestigationFormatTabMapper(BIIObjectStore store, FormatInstance formatInstance) {
        super(store, formatInstance);

        sectionMappersConfig.put("ontoSources", OntologySourceTabMapper.class);
        sectionMappersConfig.put("investigation", InvestigationTabMapper.class);
