...
import org.isatools.isatab.export.magetab.ExperimentDescriptionExportingHelper;
...
/**
 * The MAGETAB Study exporter
 */
public class StudyTabExporter extends StudyComponentTabExporter<Study> {

    public StudyTabExporter(BIIObjectStore store, Study study) {
        super(store, study);
    ...
    protected Collection<Study> getSources() {
        Collection<Study> result = new HashSet<Study>();
        result.add(study);
        return result;
    }
    ...
    protected Section getSection() {
        return MAGETABExporter.getMAGETABSchema().getDescendant("experiment", Section.class);
    }
