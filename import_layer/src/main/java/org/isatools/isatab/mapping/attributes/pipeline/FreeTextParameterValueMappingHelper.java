 ...
 * @author brandizi
 */
public class FreeTextParameterValueMappingHelper
        extends BIIPropValFreeTextMappingHelper<ProtocolApplication, Parameter, ParameterValue> {
    /**
     * Same meaning of {@link ParameterValueMappingHelper#warnAutoCreation}
     */
    protected boolean warnAutoCreation = true;


    public FreeTextParameterValueMappingHelper(
            BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, Parameter type) {
    ...
    public void setProperty(ProtocolApplication mappedObject, ParameterValue paramValue) {
        ...
        ParameterValueMappingHelper.fixProtocolParameter(mappedObject, paramValue, true);
