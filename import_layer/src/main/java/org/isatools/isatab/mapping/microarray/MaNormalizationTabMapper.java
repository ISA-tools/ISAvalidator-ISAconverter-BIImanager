...
/**
 * Maps normalized micorarray data nodes in assay files.
 * <p/>
 * Jan 2008
 *
 * @author brandizi
 */
public class MaNormalizationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public MaNormalizationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
