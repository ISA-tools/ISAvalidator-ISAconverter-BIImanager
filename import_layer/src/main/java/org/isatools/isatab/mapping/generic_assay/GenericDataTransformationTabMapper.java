 ...
 * @author brandizi
 */
public class GenericDataTransformationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public GenericDataTransformationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
