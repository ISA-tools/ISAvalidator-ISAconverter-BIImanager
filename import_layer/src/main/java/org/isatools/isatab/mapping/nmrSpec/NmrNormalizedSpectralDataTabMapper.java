 ...
 * @author brandizi
 */
public class NmrNormalizedSpectralDataTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public NmrNormalizedSpectralDataTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:nmr_spec_normalized_data", "NMR Normalized Spectral Data", new ReferenceSource("bii:data_types", "bii:data_types"))
        );
    }
