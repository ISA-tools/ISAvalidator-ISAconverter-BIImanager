...
/**
 * Maps contacts in the Investigation File. This is the old version, prior to ISATAB 0.2.
 * <p/>
 * Dec 2007
 *
 * @author brandizi
 */
public class OldContactTabMapper extends ClassTabMapper<Contact> {
    private MappingUtils mappingUtils;

    @SuppressWarnings("unchecked")
    public OldContactTabMapper(BIIObjectStore store, SectionInstance sectionInstance) {
    ...
    public Contact map(int recordIndex) {
        ...
        // TODO: actually we need multiple roles.
        ...
        log.trace("New mapped contact: " + rval);
        return rval;
    }
    ...
    public String getStoreKey(Contact mappedObject) {
        return mappedObject == null ? null : mappedObject.getEmail();
    }
