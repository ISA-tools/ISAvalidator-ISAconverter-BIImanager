...
/**
 * Maps raw microarray data nodes.
 * <p/>
 * Feb 2008
 *
 * @author brandizi
 */
public class MaRawDataTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public MaRawDataTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        super(store, sectionInstance, fieldIndex, endField);

        // "Scan Name" is the first field
