...
/**
 * Maps protocols in Investigation file. This is the old version, prior to ISATAB 0.2.
 * <p/>
 * Dec 2007
 *
 * @author brandizi
 */
public class OldProtocolTabMapper extends ClassTabMapper<Protocol> {
    private MappingUtils mappingUtils;

    @SuppressWarnings("unchecked")
    public OldProtocolTabMapper(BIIObjectStore store, SectionInstance sectionInstance) {
    ...
    public Protocol map(int recordIndex) {
        // Basic properties
        Protocol rval = super.map(recordIndex);

        // Other stuff
        log.trace("New mapped protocol: " + rval);
        return rval;
    }
    ...
    public String getStoreKey(Protocol mappedObject) {
        return mappedObject == null ? null : mappedObject.getName();
    }
