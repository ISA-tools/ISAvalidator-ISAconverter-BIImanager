...
public class FactorTabMapper extends ClassTabMapper<FactorTypeHelper> implements StudyComponentTabMapper {
    ...
    public FactorTypeHelper map(int recordIndex) {
        ...
        OntologyTerm factorType = mappingUtils.createOntologyEntry(
                ...
                "Factor Type Term Accession Number", "Factor Type", "Factor Type Term Source REF", OntologyTerm.class
        );
        ...
        if (mappedStudy == null) {
            throw new TabMissingValueException(i18n.msg("orphan_factor", factorType));
        } else {
        ...
        // Other stuff
        log.trace("New/Saved mapped factor: " + result);
        return result;
    }
