...
package org.isatools.isatab.mapping.microarray;
...
/**
 * Data Transformation mapper for the transcriptomics/microarray case.
 * <p/>
 * <dl><dt>date:</dt><dd>Nov 27, 2008</dd></dl>
 *
 * @author brandizi
 */
public class MaDataTransformationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public MaDataTransformationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
