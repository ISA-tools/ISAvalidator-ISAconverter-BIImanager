...
/**
 * Maps normalized data nodes in generic assay files.
 * <p/>
 * Jan 2008
 *
 * @author brandizi
 */
public class GenericNormalizationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public GenericNormalizationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        super(store, sectionInstance, fieldIndex, endField);

        // Mapped by "Normalization Name"
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:generic_assay_normalized_data", "Generic Normalized Data", new ReferenceSource("bii:data_types", "bii:data_types"))
        );
    }
