 ...
 * @author brandizi
 */
public class PublicationTabMapper extends ClassTabMapper<Publication> implements StudyComponentTabMapper {
    ...
    public Publication map(int recordIndex) {
        ...
        PublicationStatus status = (PublicationStatus) mappingUtils.createOntologyEntry(
                getSectionInstance(), recordIndex, "Publication Status", "Publication Status", source, PublicationStatus.class
        );
