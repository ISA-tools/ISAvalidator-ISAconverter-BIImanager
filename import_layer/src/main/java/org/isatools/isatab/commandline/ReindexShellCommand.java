...
public class ReindexShellCommand extends AbstractImportLayerShellCommand {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CommandLine cmdl = AbstractImportLayerShellCommand.parseCommandLine(
                    clopts, args, ReindexShellCommand.class
            );
    ...
    public static void printUsage(Options opts) {
        ...
        helpFormatter.printHelp(pw, 80,
                "reindex",
                "\nRecreate the Lucene Index for the BII database. Can be useful after manual changes of the DB",
                opts,
                2, 4,
                "\n",
                false
