...
//
///**
// * Performs the MAGETAB/AE creation
// * 
// * date: Jun 6, 2008
// * @author brandizi
// *
// */
//public class MAGETABDispatchShellCommand extends AbstractImportLayerShellCommand
//{
...
//			setupLog4JPath ( exportPath + "/magetab/isatools.log" );
//			// Need to initialize this here, otherwise above config will fail
//			log = Logger.getLogger ( MAGETABDispatchShellCommand.class );
//
...
//		}
//		catch ( Exception ex ) {
//			log.fatal ( "ERROR: problem while running the MAGETAB dispatcher: " + ex.getMessage (), ex );
//		}
//	}
//}
