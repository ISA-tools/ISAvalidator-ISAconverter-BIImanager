...
public class ContentsShellCommand extends AbstractImportLayerShellCommand {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            clopts.addOption(
                    OptionBuilder
                            .withDescription("List all the studies and their permissions/ownership")
                            .withLongOpt("studies")
                            .create("s")
            );
            clopts.addOption(
            ...
            CommandLine cmdl = AbstractImportLayerShellCommand.parseCommandLine(
                    clopts, args, ContentsShellCommand.class
            );
    ...
    public static void printUsage(Options opts) {
        ...
        helpFormatter.printHelp(pw, 80,
                "contents <options>",
                "\nShows contents from the BII DB.\n\nOptions:",
                opts,
                2, 4,
                "\n",
                false
