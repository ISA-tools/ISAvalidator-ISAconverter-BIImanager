...
public class UserDelShellCommand extends AbstractImportLayerShellCommand {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CommandLine cmdl = AbstractImportLayerShellCommand.parseCommandLine(
                    clopts, args, UserDelShellCommand.class
            );
    ...
    public static void printUsage(Options opts) {
        ...
        helpFormatter.printHelp(pw, 80,
                "usedel [options] login",
                "\nDelete a user from the BII DB.\n\nOptions:",
                opts,
                2, 4,
                "\n",
                false
