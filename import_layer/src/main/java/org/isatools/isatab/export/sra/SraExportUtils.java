 ...
 */
abstract class SraExportUtils extends SraExportComponent {

    protected SraExportUtils(final BIIObjectStore store, final String sourcePath, final String exportPath) {
        super(store, sourcePath, exportPath);
    }

    /**
     * Adds a data file to the SRA submission.
     *
     * @param xsubFiles the FILES node that belongs to the SUBMISSION node in SRA. FILE elements will be added to this.
...
//                }
//
//        xfile.setChecksum(fileToMD5.get(fileName));
