 ...
 * @author brandizi
 */
public class SectionBlockInstance implements FormatInstanceComponent {
    private List<SectionInstance> sectionInstances = new ArrayList<SectionInstance>();

    public SectionBlockInstance(List<SectionInstance> sectionInstances) {
    ...
    public void addSectionInstance(SectionInstance sectionInstance) {
        this.sectionInstances.add(sectionInstance);
    }
