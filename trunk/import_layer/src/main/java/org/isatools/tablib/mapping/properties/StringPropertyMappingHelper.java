...
/**
 * Maps a string property, assuming a setter in the form set&lt;{@link #getPropertyName()}&gt;() exists.
 * <p/>
 * Jan 28, 2008
 *
 * @author brandizi
 */
public class StringPropertyMappingHelper<T extends Identifiable>
        extends PropertyMappingHelper<T, String> {

    public StringPropertyMappingHelper(
     ...
     */
    @Override
    public String mapProperty(int recordIndex) {
        String tabValue = this.getSectionInstance().getString(recordIndex, getFieldIndex());
        return StringUtils.trimToNull(tabValue);
    }
