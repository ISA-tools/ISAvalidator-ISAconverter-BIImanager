 ...
 * @author brandizi
 */
public abstract class HeadedCsvIterator<OT> extends CsvIterator<OT> {
    /**
    ...
    protected HeadedCsvIterator() {
        super();
    }

    public HeadedCsvIterator(CSVReader csvReader) throws IOException {
    ...
    protected void initFirstObject() throws IOException {
        ...
        super.initFirstObject();
    }

    /**
     * Gets the line value corresponding to the given header
     */
    protected String getValue(String[] line, String header) {
