...
/**
 * Used to map those paramters which have a unit.
 * <p/>
 * Jan 15, 2008
 *
 * @author brandizi
 */
public class QtyParamMappingHelper extends QtyBIIPropValMappingHelper<ProtocolApplication, Parameter, ParameterValue> {
    /**
     * Same meaning of {@link ParameterValueMappingHelper#warnAutoCreation}
     */
    protected boolean warnAutoCreation = true;

    public QtyParamMappingHelper(
            BIIObjectStore store, SectionInstance sectionInstance,
            int fieldIndex, Parameter type
    ) {
    ...
    public void setProperty(ProtocolApplication mappedObject, ParameterValue paramValue) {
        ...
        ParameterValueMappingHelper.fixProtocolParameter(mappedObject, paramValue, warnAutoCreation);
