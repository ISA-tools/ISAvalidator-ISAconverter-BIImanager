...
/**
 * Maps single Mass Spectrometry runs in (mass spectrometry) assay files.
 * <p/>
 * Jan 2008
 *
 * @author brandizi
 */
public class MsRunTabMapper extends MaterialNodeTabMapper<Material> {

    @SuppressWarnings("unchecked")
    public MsRunTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        // "MS Assay Name" is the starting header
    ...
    public Material map(int recordIndex) {
        ...
        Material msSpec = super.map(recordIndex);
    ...
    public Material newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Material(
                "", new MaterialRole("bii:ms_spec", "Mass Spectrometry Run",
