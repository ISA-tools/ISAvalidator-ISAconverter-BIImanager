 ...
 * @author brandizi
 */
public class SampleFVMappingHelper
        extends AbstractFactorValueMappingHelper<Material> {

    public SampleFVMappingHelper(BIIObjectStore store, SectionInstance sectionInstance,
                                 Map<String, String> options, int fieldIndex) {
        super(store, sectionInstance, options, fieldIndex);
    }

    public SampleFVMappingHelper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex) {
     ...
     */
    @Override
    public void setProperty(Material mappedObject, FactorValue factorValue) {
        if (factorValue == null) {
            return;
        }
    ...
    /**
     * Handles the mapping of factor values and the population of sample biomaterials with FVs.
     * <p/>
    ...
    protected class FreeTextFactorValueMappingHelper
            extends BIIPropValFreeTextMappingHelper<Material, Factor, FactorValue> {
    ...
    /**
     * Handle the mapping of FVs to be stored into sample biomaterials, taking care of those FVs that are quantities.
     * <p/>
     * <dl><dt>date:</dt><dd>Oct 20, 2008</dd></dl>
     *
     * @author brandizi
     */
    public class QtyFactorValueMappingHelper extends QtyBIIPropValMappingHelper<Material, Factor, FactorValue> {
