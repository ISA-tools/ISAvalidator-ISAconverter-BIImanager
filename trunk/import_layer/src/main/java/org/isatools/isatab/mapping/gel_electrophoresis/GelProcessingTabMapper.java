 ...
 * @author brandizi
 */
public class GelProcessingTabMapper extends ProcessingsTabMapper {

    public GelProcessingTabMapper(BIIObjectStore store, SectionInstance sectionInstance) {
        ...
        nodeMappersConfig.put("Gel Electrophoresis Assay Name", GelAssayTabMapper.class);
        nodeMappersConfig.put("Scan Name", GelRawDataTabMapper.class);
        nodeMappersConfig.put("Normalization Name", GelNormalizationTabMapper.class);
        nodeMappersConfig.put("Data Transformation Name", GelDataTransformationTabMapper.class);
    }
