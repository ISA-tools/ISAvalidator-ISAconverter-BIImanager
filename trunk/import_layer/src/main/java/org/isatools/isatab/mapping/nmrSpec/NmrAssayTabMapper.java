...
package org.isatools.isatab.mapping.nmrSpec;
...
/**
 * Maps single NMR spectroscopy runs in (NMR spectroscopy) assay files.
 * <p/>
 * Jan 2008
 *
 * @author brandizi
 */
public class NmrAssayTabMapper extends MaterialNodeTabMapper<Material> {

    public NmrAssayTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        // "NMR Assay Name" is the matching header.

        super(store, sectionInstance, fieldIndex, endField);

        // TODO: remove, This was moved to the acquisition protocol
//		this.mappingHelpersConfig.put ( "Acquisition Parameter Data File", 
//			new MappingHelperConfig<AnnotationMappingHelper> ( AnnotationMappingHelper.class, 
//				new String [][] { { "propertyName", "acquisitionParameterFile" }} 
//		));
        // TODO: remove, This was moved to data transformation / normalization
...
//		));
    ...
    public Material map(int recordIndex) {
        ...
        Material nmrSpec = super.map(recordIndex);
    ...
    public Material newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Material(
                "", new MaterialRole("bii:nmr_spec", "NMR Spectrometry Run",
