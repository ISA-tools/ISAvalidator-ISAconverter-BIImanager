 ...
 * @author brandizi
 */
public class MsDataTransformationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public MsDataTransformationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:ms_spec_derived_data", "MS/SPEC Derived Data", new ReferenceSource("bii:data_types", "bii:data_types"))
        );
    }
