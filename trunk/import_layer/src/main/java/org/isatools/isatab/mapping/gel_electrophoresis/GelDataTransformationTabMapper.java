...
/**
 * <dl><dt>date:</dt><dd>Jan 5, 2009</dd></dl>
 *
 * @author brandizi
 */
public class GelDataTransformationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public GelDataTransformationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:gel_derived_data", "Generic Derived Data", new ReferenceSource("bii:data_types", "BII Data Types"))
        );
    }
