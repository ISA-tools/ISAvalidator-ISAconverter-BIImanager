 ...
 * @author brandizi
 */
public class GenericRawDataTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public GenericRawDataTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        super(store, sectionInstance, fieldIndex, endField);

        // First column is "Raw Data File"
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:generic_assay_raw_data", "Generic Raw Data", new ReferenceSource("bii:data_types", "bii:data_types"))
        );
    }
