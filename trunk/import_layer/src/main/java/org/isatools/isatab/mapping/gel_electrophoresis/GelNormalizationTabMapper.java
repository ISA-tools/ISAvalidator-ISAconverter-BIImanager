 ...
 * @author brandizi
 */
public class GelNormalizationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public GelNormalizationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        super(store, sectionInstance, fieldIndex, endField);

        // "Normalization Name" is the first col.
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:gel_normalized_data", "Generic Normalized Data", new ReferenceSource("bii:data_types", "BII Data Types"))
        );
    }
