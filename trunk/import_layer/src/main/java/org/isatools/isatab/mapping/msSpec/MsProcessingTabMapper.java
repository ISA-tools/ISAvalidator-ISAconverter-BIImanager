 ...
 * @author brandizi
 */
public class MsProcessingTabMapper extends ProcessingsTabMapper {

    public MsProcessingTabMapper(BIIObjectStore store, SectionInstance sectionInstance) {
        ...
        nodeMappersConfig.put("MS Assay Name", MsRunTabMapper.class);
        nodeMappersConfig.put("Raw Spectral Data File", MsDataTabMapper.class);
        nodeMappersConfig.put("Data Transformation Name", MsDataTransformationTabMapper.class);
        nodeMappersConfig.put("Normalization Name", MsNormalizedSpectralDataTabMapper.class);
    }
}
