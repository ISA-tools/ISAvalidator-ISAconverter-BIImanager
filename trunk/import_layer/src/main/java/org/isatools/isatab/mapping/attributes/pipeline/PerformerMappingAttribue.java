...
public class PerformerMappingAttribue extends ParameterValueMappingHelper {
    public PerformerMappingAttribue(BIIObjectStore store, SectionInstance sectionInstance,
        ...
        field.setAttr("type", "Performer");
        warnAutoCreation = false;
    }

    public PerformerMappingAttribue(
