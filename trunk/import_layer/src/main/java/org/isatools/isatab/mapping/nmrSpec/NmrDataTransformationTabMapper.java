...
/**
 * <dl><dt>date:</dt><dd>Nov 27, 2008</dd></dl>
 *
 * @author brandizi
 */
public class NmrDataTransformationTabMapper extends DataNodeTabMapper {

    @SuppressWarnings("unchecked")
    public NmrDataTransformationTabMapper(BIIObjectStore store, SectionInstance sectionInstance, int fieldIndex, int endField) {
        // "Data Transformation Name" is the starting node
    ...
    public Data newMappedObject() throws InstantiationException, IllegalAccessException {
        ...
        //
        return new Data(
                "", new DataType("bii:nmr_spec_derived_data", "NMR Spectral Derived Data", new ReferenceSource("bii:data_types", "bii:data_types"))
        );
    }
