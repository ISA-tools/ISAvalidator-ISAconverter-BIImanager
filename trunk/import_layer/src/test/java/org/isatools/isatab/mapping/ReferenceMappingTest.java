...
public class ReferenceMappingTest {
	...
	public ReferenceMappingTest() throws Exception {
		super();

		InputStream input = new BufferedInputStream(this.getClass().getResourceAsStream("/test-data/isatab/isatab_2_refs.xml"));
		...
		formatInstance = loader.parse(
				...
				new BufferedReader(new InputStreamReader(this.getClass().getResourceAsStream(
						"/test-data/isatab/isatab_2_refs.csv"))), "references"
		);
	}
	...
	public void testBasicMapping() {
		out.println("\n\n\n ________ Testing Reference Section _________");
		...
		out.println("________ /end: Testing Reference Section _________\n\n\n");
	}
