...
/**
 * Simple structured property that can be attached to an {@link ExperimentNode}.
 * <p/>
...
public class Annotation {
	...
	private final OntoTerm ontoTerm;

	public Annotation(String type, String value, String termAcc, String termSrc) {
		this.type = type;
		this.value = value;
		ontoTerm = termAcc != null && termSrc != null
				? new OntoTerm(termAcc, termSrc)
				: null;
	}
