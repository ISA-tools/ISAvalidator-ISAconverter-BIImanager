 ...
 * experimental graph. This class invokes {@link ChainsBuilder} and produce a matrix of strings from the
 * chains that this class creates from the input graph.
 * <p/>
...
public class TableBuilder {
    ...
    /**
     * Pass me the nodes that allows to reach the source nodes in the exported graph (the leftmost ones, the ones
     * that have no input).
     */
    ...
    /**
     * This add a node of the chains prepared by {@link ChainsBuilder} to the exported table. This is
     * done by considering the pairs returned by {@link Node#getTabValues()}, values with the same header are
     * merged.
     */
    private void addNode(int layer, Node node) {
        ...
        for (TabValueGroup tbg : node.getTabValues()) {
            ...
            // TODO: This screw the grouping of headers of the same type (eg: factor value could fall between two characteristics
