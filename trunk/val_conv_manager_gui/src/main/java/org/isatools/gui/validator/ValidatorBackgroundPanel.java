...
package org.isatools.gui.validator;
...
public class ValidatorBackgroundPanel extends GenericPanel {

    private static Image logo = new ImageIcon(GenericPanel.class.getResource("/images/validator/validator_logo.png")).getImage();
    ...
    private static Image abstract_central_logo = new ImageIcon(GenericPanel.class.getResource("/images/validator/abstract_validator_logo.png")).getImage();
