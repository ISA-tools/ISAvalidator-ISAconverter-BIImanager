...
public class ViewingPane extends JPanel {
    protected SmallLoader sl;
    protected AppContainer container;

    public ViewingPane(AppContainer container) {
    ...
    protected JPanel createProgressScreen(String text) {
        ...
        loadingPanel.setPreferredSize(new Dimension(300, 100));

        sl = new SmallLoader(10, 5.0f, 300, 70, text);
        loadingPanel.add(sl);
    ...
    public AppContainer getApplicationContainer() {
        return container;
    }
