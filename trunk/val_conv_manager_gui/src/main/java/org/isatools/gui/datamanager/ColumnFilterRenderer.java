...
public class ColumnFilterRenderer extends JComponent
    ...
    public ColumnFilterRenderer() {
        this(UIHelper.VER_10_BOLD, UIHelper.LIGHT_GREEN_COLOR, UIHelper.VER_10_PLAIN, UIHelper.LIGHT_GREY_COLOR,
                Globals.LIST_ICON_DEFAULT);

    }


    public ColumnFilterRenderer(Font selectedFont, Color selectedColor, Font unselectedFont, Color unselectedColor, ImageIcon image) {
        ...
        image = (image == null) ? Globals.LIST_ICON_DEFAULT : image;
    ...
    public Component getListCellRendererComponent(JList jList, Object val,
        ...
        for (Component c : components) {
            ...
            if (selected) {
                ...
                c.setForeground(unselectedColor);
            }
        }
